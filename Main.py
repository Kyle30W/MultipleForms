...
def DrivingLicense():
    ...
    lblAge = Label(DLForm, text="Enter Your Name Age", fg="Black", bg="dimgrey")
...
def ThursdayChallenge():
    ...
    # Build the Form
    Form = Tk()  # this creates a GUI and assign it a name.
    Form.title("Scale Challenge - Kyle Wilkinson")
    Form.configure(bg="dimgrey")
...
btnThursdayChallenge = Button(Form, text="ThursdayChallenge", fg="Black", bg="White", command = ThursdayChallenge)
...
btnThursdayChallenge.place(x=115, y=350, width=120, height=30)
